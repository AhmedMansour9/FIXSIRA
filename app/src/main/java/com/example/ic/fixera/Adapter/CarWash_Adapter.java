...
public class CarWash_Adapter extends RecyclerView.Adapter<CarWash_Adapter.MyViewHolder> implements Filterable {
    ...
    @Override
    public CarWash_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemcarwashing, parent, false);
        return new CarWash_Adapter.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final CarWash_Adapter.MyViewHolder holder, final int position) {
